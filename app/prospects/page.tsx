        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Search prospects by name, address, notes..."
                value={searchTerm}
          ...
          {allBusinesses.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <h3 className="text-lg font-medium text-foreground mb-1">No prospects yet</h3>
              <p className="text-sm text-muted-foreground max-w-md">
                Search for businesses and click "Add to Prospects" on the ones you want to pitch.
            ...
            <>
              <p className="text-sm text-muted-foreground">
                Showing {filtered.length} of {allBusinesses.length} prospects
              </p>

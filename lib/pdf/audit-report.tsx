    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer}>
          Report generated by {companyName || "MarketMojo.ai"} • {now} • Page 1
        </Text>
      </Page>

      {/* Page 2: Services and Next Steps */}
      <Page size="A4" style={styles.page}>
        {/* Header on Page 2 (Reduced) */}
        <View style={[styles.header, { marginBottom: 20 }]}>
          <Text style={{ fontSize: 14, fontWeight: "bold", color: "#0d9488" }}>
            Plan of Action: {business.name}
          </Text>
          <Text style={styles.subtitle}>{now}</Text>
        </View>
        ...
        {/* Footer for Page 2 */}
        <Text style={styles.footer}>
          Report generated by {companyName || "MarketMojo.ai"} • {now} • Page 2
        </Text>
      </Page>
    </Document>
  )

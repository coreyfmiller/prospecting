...
export function computeDeterministicGeoFlags(text: string): {
  ...
  // Promotional tone: % of sales words — steeper curve, no baseline
  let salesCount = 0;
  ...
  // 3% sales words = 100 (steeper than before)
